...
.overlay-toolbar{position:fixed;top:16px;right:20px;z-index:10000;display:flex;gap:8px;align-items:center}
...
.card.is-fav .card-info::after{content:'♥';position:absolute;top:8px;right:10px;color:#f5576c;font-size:.7rem}
.card-info{position:relative}
.ctrl-panel{position:fixed;top:60px;right:16px;z-index:10000;width:240px;background:rgba(20,20,20,.95);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid rgba(255,255,255,.08);border-radius:12px;padding:16px;display:none;flex-direction:column;gap:12px}
.ctrl-panel.open{display:flex}
.ctrl-panel h4{font-size:.7rem;font-weight:600;color:rgba(255,255,255,.5);text-transform:uppercase;letter-spacing:.05em;margin:0}
.ctrl-row{display:flex;align-items:center;gap:10px}
.ctrl-row label{font-size:.68rem;color:rgba(255,255,255,.5);width:42px;flex-shrink:0}
.ctrl-row input[type="range"]{flex:1;height:4px;-webkit-appearance:none;appearance:none;background:rgba(255,255,255,.1);border-radius:2px;outline:none}
.ctrl-row input[type="range"]::-webkit-slider-thumb{-webkit-appearance:none;width:14px;height:14px;border-radius:50%;background:#667eea;cursor:pointer;border:2px solid rgba(255,255,255,.2)}
.ctrl-row input[type="color"]{width:28px;height:28px;border:2px solid rgba(255,255,255,.1);border-radius:6px;cursor:pointer;padding:0;background:none;-webkit-appearance:none}
.ctrl-row input[type="color"]::-webkit-color-swatch-wrapper{padding:2px}
.ctrl-row input[type="color"]::-webkit-color-swatch{border-radius:3px;border:none}
.ctrl-row .val{font-size:.62rem;color:rgba(255,255,255,.35);width:32px;text-align:right;flex-shrink:0}
.ctrl-reset{margin-top:4px;padding:6px 12px;border-radius:6px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.08);color:rgba(255,255,255,.5);font-size:.65rem;cursor:pointer;transition:all .15s;text-align:center}
.ctrl-reset:hover{background:rgba(255,255,255,.1);color:rgba(255,255,255,.8)}
`;
...
const overlayHtml = `<div class="effect-overlay" id="overlay">
  <div class="overlay-toolbar">
    ...
    <button class="overlay-btn" id="ctrlToggle" title="调节"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg></button>
  ...
  <div class="ctrl-panel" id="ctrlPanel">
    <h4>效果调节</h4>
    <div class="ctrl-row"><label>速度</label><input type="range" id="ctrlSpeed" min="0.1" max="3" step="0.1" value="1"><span class="val" id="ctrlSpeedVal">1x</span></div>
    <div class="ctrl-row"><label>缩放</label><input type="range" id="ctrlScale" min="0.3" max="2.5" step="0.1" value="1"><span class="val" id="ctrlScaleVal">1x</span></div>
    <div class="ctrl-row"><label>色相</label><input type="range" id="ctrlHue" min="0" max="360" step="1" value="0"><span class="val" id="ctrlHueVal">0°</span></div>
    <div class="ctrl-row"><label>饱和</label><input type="range" id="ctrlSat" min="0" max="200" step="5" value="100"><span class="val" id="ctrlSatVal">100%</span></div>
    <div class="ctrl-row"><label>亮度</label><input type="range" id="ctrlBright" min="50" max="200" step="5" value="100"><span class="val" id="ctrlBrightVal">100%</span></div>
    <div class="ctrl-row"><label>模糊</label><input type="range" id="ctrlBlur" min="0" max="10" step="0.5" value="0"><span class="val" id="ctrlBlurVal">0</span></div>
    <div class="ctrl-row"><label>背景</label><input type="color" id="ctrlBg" value="#111111"></div>
    <button class="ctrl-reset" id="ctrlReset">重置</button>
  </div>
