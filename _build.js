...
.effect-overlay iframe{flex:1;width:100%;border:none}
...
.ctrl-bar{flex-shrink:0;background:rgba(17,17,17,.96);border-top:1px solid rgba(255,255,255,.06);padding:12px 20px;display:flex;align-items:center;gap:16px;overflow-x:auto;scrollbar-width:none;-ms-overflow-style:none}
.ctrl-bar::-webkit-scrollbar{display:none}
.ctrl-item{display:flex;align-items:center;gap:6px;flex-shrink:0}
.ctrl-item label{font-size:.65rem;color:rgba(255,255,255,.4);white-space:nowrap}
.ctrl-item input[type="range"]{width:80px;height:3px;-webkit-appearance:none;appearance:none;background:rgba(255,255,255,.1);border-radius:2px;outline:none}
.ctrl-item input[type="range"]::-webkit-slider-thumb{-webkit-appearance:none;width:12px;height:12px;border-radius:50%;background:#667eea;cursor:pointer;border:2px solid rgba(255,255,255,.2)}
.ctrl-item input[type="color"]{width:22px;height:22px;border:2px solid rgba(255,255,255,.1);border-radius:5px;cursor:pointer;padding:0;background:none;-webkit-appearance:none}
.ctrl-item input[type="color"]::-webkit-color-swatch-wrapper{padding:1px}
.ctrl-item input[type="color"]::-webkit-color-swatch{border-radius:3px;border:none}
.ctrl-item .val{font-size:.6rem;color:rgba(255,255,255,.3);min-width:24px}
.ctrl-reset-btn{padding:4px 10px;border-radius:5px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.08);color:rgba(255,255,255,.4);font-size:.6rem;cursor:pointer;transition:all .15s;white-space:nowrap;flex-shrink:0}
.ctrl-reset-btn:hover{background:rgba(255,255,255,.12);color:rgba(255,255,255,.7)}
`;
...
const overlayHtml = `<div class="effect-overlay" id="overlay">
  ...
  <div class="ctrl-bar" id="ctrlBar">
    <div class="ctrl-item"><label>速度</label><input type="range" id="ctrlSpeed" min="0.1" max="3" step="0.1" value="1"><span class="val" id="ctrlSpeedVal">1x</span></div>
    <div class="ctrl-item"><label>缩放</label><input type="range" id="ctrlScale" min="0.3" max="2.5" step="0.1" value="1"><span class="val" id="ctrlScaleVal">1x</span></div>
    <div class="ctrl-item"><label>色相</label><input type="range" id="ctrlHue" min="0" max="360" step="1" value="0"><span class="val" id="ctrlHueVal">0°</span></div>
    <div class="ctrl-item"><label>饱和</label><input type="range" id="ctrlSat" min="0" max="200" step="5" value="100"><span class="val" id="ctrlSatVal">100%</span></div>
    <div class="ctrl-item"><label>亮度</label><input type="range" id="ctrlBright" min="50" max="200" step="5" value="100"><span class="val" id="ctrlBrightVal">100%</span></div>
    <div class="ctrl-item"><label>模糊</label><input type="range" id="ctrlBlur" min="0" max="10" step="0.5" value="0"><span class="val" id="ctrlBlurVal">0</span></div>
    <div class="ctrl-item"><label>背景</label><input type="color" id="ctrlBg" value="#111111"></div>
    <button class="ctrl-reset-btn" id="ctrlReset">重置</button>
  </div>
</div>`;
